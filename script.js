...
const music_list = [
{
img : 'https://i.ytimg.com/vi/1NOPHb4Xegk/maxresdefault.jpg',
name : 'Happy Birthday',
artist : 'GMSLive',
music : 'music/HBD.mp3'
},
...
// JavaScript untuk mengatur animasi pengetikan per huruf
document.addEventListener('DOMContentLoaded', function () {
    var text = "Happy Birthday to you";
    var span = document.getElementById('birthday-span');
    var index = 0;
    ...
    function typeWriter() {
        if (index < text.length) {
            ...
            index++;
            setTimeout(typeWriter, 150); // Ganti nilai ini untuk mengatur kecepatan pengetikan
        }
    }
      ...
      <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
        <div class="bg-white rounded shadow-sm">
          <div class="aspect-ratio">
            <img :src="card.imgSrc" alt="" class="img-fluid card-img-top">
          </div>
          <div class="p-4">
            <h5><a href="#" class="text-dark">{{ card.title }}</a></h5>
            <p class="small text-muted mb-0">{{ card.desc }}</p>
            <div class="d-flex align-items-center justify-content-between rounded-pill bg-light px-3 py-2 mt-4">
              <p class="small mb-0"><i class="fa fa-picture-o mr-2"></i><span class="font-weight-bold">{{ card.fileType }}</span></p>
              <div class="badge" :class="'badge-' + card.badgeType.toLowerCase() + ' px-3 rounded-pill font-weight-normal'">{{ card.badgeType }}</div>
            </div>
          </div>
        </div>
      </div>
